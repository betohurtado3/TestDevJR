...
Nombre: Heriberto Hurtado Valle
...
------
## Prueba 1 ##
* Lee la documentación del API de [JSONPlaceholder](http://jsonplaceholder.typicode.com/guide/) y crea una aplicación web (dentro del directorio **Prueba_1**) en ReactJS que realice lo siguiente:
